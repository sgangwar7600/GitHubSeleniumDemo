...
public class MaternityBenefitExpectedConfinementCompleteFlow extends Browserfactory {
	...
	@Test(priority = 1)
	public void LoginforMBExpectedConfinement() throws InterruptedException, IOException {
	...
	@Test(priority = 2)
	public void MaternityForm18CertificateExpectedConfinement() throws InterruptedException {
			...
			js1.executeScript("document.getElementById('ctl00_HomePageContent_txtIssueDate').value='15/04/2021'");
			Thread.sleep(2000);
            MB.IMOName().sendKeys("TEst");
			MB.ExpectedConfinementType().click();
			Thread.sleep(2000);
			JavascriptExecutor js2 = (JavascriptExecutor) driver;
			js2.executeScript("document.getElementById('ctl00_HomePageContent_txtExDt').value='08/06/2021'");
			Thread.sleep(2000);
	...
	@Test(priority = 3)
	public void MBCreateExpectedConfinementClaim() throws InterruptedException {
	...
	@Test(priority = 4)
	public void MB_Form19ExpectedConfinement() throws InterruptedException, AWTException {
		 MB = new MaternityBenefitPage(driver);
		 Thread.sleep(1000);
		// Create acknowledge
		MB.CreateAckn().click();
		...
		MB.Back().click();
        Thread.sleep(1000);
         //Expected Confinement radio Btn
        driver.findElement(By.id("ctl00_HomePageContent_RListmbfor_0")).click();
        
		// MB Start Date
		JavascriptExecutor js = (JavascriptExecutor) driver;

		js.executeScript("document.getElementById('ctl00_HomePageContent_txtmbstartdate').value='15/04/2021'");
        Thread.sleep(1000);
	...
	@Test(priority = 5)
	public void BMLoginforExpectedConfinement() throws InterruptedException, IOException {
	...
	@Test(priority = 6)
	public void ExpectedMBForm19ClaimProcessingBMLogin() throws InterruptedException {
