...
import com.qa.pages.TaskDetailsPage;
import com.qa.util.Browserfactory;
import com.qa.util.ReusableFunction;

public class TaskDetailsTest extends Browserfactory{
	...
	@Test(priority=1)
	public void LoginforTaskDetails() throws InterruptedException, IOException{
...
*/
	...
	TD=new TaskDetailsPage(driver);
	TD.doNavigateToTaskDetailsPage();
	}
