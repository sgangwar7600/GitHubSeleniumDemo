...
import com.qa.pages.ViewSubUnitsPage;
import com.qa.util.Browserfactory;
import com.qa.util.ReusableFunction;

public class ViewSubUnitsTest extends Browserfactory{
	
	SoftAssert as =new SoftAssert();
	WebDriver driver;
	
	LoginPage log;
	ViewSubUnitsPage VSUP;
	
	
	@Test(priority=1)
	public void LoginforViewSubUnits() throws InterruptedException, IOException{
...
*/	
	...
	@Test(priority=2)
	public void ViewRegister()throws InterruptedException, IOException{
		VSUP=new ViewSubUnitsPage(driver);
		VSUP.doNavigateToViewSubUnits(ReusableFunction.getValue("EmployersCode"));
