...
public class ActionOnInterestTest extends Browserfactory {
	...
	@Test(priority = 1)
	public void LoginforActionOnInterest() throws InterruptedException, IOException  {
	...
	public void ActionOnInterest() {
		...
		try{
			...
			Thread.sleep(2000);	
			AOD.ActionsOnInterest().click();
			Thread.sleep(2000);	
			System.out.println("Actions On Interest");
			Thread.sleep(2000);	
			...
			Thread.sleep(2000);	
			//AOD.EmployerCodeLink().click();
			driver.findElement(By.linkText(EmployersCode)).click();
			Thread.sleep(2000);	
			AOD.SelectRadioBtn().click();
			Thread.sleep(2000);
			AOD.RemarksTxtBx().sendKeys("Test");
			Thread.sleep(2000);
			AOD.AOISubmitBtn().click();
	...
	@Test(priority = 3)
	public void SOLoginForAOI() throws InterruptedException, IOException {
	...
	@Test(priority = 4) 
	public void ActionOnInterestSOLogin() {
		...
		try{
			...
			utilobj.MoveElement(AOD.ActionOnDefaulter(), driver);
			Thread.sleep(2000);	
		//	utilobj.ActionClick(AOD.MyTaskList(), driver);
			AOD.MyTaskList().click();
			Thread.sleep(2000);
			AOD.ActionOnInterestLink().click();
	...
	@Test(priority = 5)
	public void RBOLoginForAOI() throws InterruptedException, IOException {
	...
	@Test(priority = 6) 
	public void ActionOnInterestRBOLogin() {
