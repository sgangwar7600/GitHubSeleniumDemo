...
import com.qa.pages.ChangeIPStatusOnDeathPage;
import com.qa.pages.LoginPage;
import com.qa.util.Browserfactory;
import com.qa.util.ReusableFunction;

public class ChangeIpStatusOnDeathTest extends Browserfactory{
	
	SoftAssert as =new SoftAssert();
	WebDriver driver;
	
	LoginPage log;
	ChangeIPStatusOnDeathPage CIPOD;
	
	
	@Test(priority=1)
	public void LoginforChangeIpStatusOnDeath() throws InterruptedException, IOException {
...
*/	}
	...
	@Test(priority=2)
	public void ChangeIPStatusOnDeath()throws InterruptedException, IOException{
	CIPOD=new ChangeIPStatusOnDeathPage(driver);
	CIPOD.doNavigateToChangeIpOnDeathPage(ReusableFunction.getValue("IpNo"));
	}
/*	
	@AfterTest
