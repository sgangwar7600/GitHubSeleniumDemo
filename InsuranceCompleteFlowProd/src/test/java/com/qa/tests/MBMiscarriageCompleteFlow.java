...
public class MBMiscarriageCompleteFlow extends Browserfactory {
	...
	@Test(priority = 1)
	public void LoginforMiscarriage() throws InterruptedException, IOException {
	...
	@Test(priority = 2)
	public void MaternityForm18MiscarriageCertificate() throws InterruptedException {
			...
			js1.executeScript("document.getElementById('ctl00_HomePageContent_txtIssueDate').value='12/08/2021'");
			Thread.sleep(2000);
            
			MB.MiscarriageRadioBtn().click();
			Thread.sleep(2000);
			JavascriptExecutor js2 = (JavascriptExecutor) driver;
			js2.executeScript("document.getElementById('ctl00_HomePageContent_txtMiscDt').value='11/08/2021'");
			Thread.sleep(2000);
			driver.findElement(By.id("ctl00_HomePageContent_txtMiscAt")).sendKeys("Test");
			Thread.sleep(2000);
	...
	@Test(priority = 3)
	public void MBMiscarriageCreateClaim() throws InterruptedException {
...
*/
	...
	@Test(priority = 4)
	public void MB_Form19Miscarriage() throws InterruptedException, AWTException {
		 MB = new MaternityBenefitPage(driver);
		 Thread.sleep(1000);
		// Create acknowledge
		MB.CreateAckn().click();
		...
		js.executeScript("document.getElementById('ctl00_HomePageContent_txtmbstartdate').value='12/08/2021'");
        Thread.sleep(1000);

        //MB Type Miscarriage
		driver.findElement(By.id("ctl00_HomePageContent_RListmbfor_2")).click();
	...
	@Test(priority = 5)
	public void BMLoginforMiscarriage() throws InterruptedException, IOException {
		Thread.sleep(2000);
	...
	@Test(priority = 6)
	public void MBForm19MiscarriageClaimProcessingBMLogin() throws InterruptedException {
...
//			MB.BMApproveBtn().click();
	...
	public void tearDown(ITestResult result) throws IOException{
		...
		{
			String MBMiscarriageClaim= utilobj.getScreenshot(driver, "MBMiscarriageClaim");
			logger.fail(result.getThrowable().getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(MBMiscarriageClaim).build());
		}
	}
