...
public class SicknessBenefitCompleteFlow extends Browserfactory {
	...
	@Test(priority = 1)
	public void LoginForSB() throws InterruptedException, IOException  {
	...
	@Test(priority = 2)
	public void FirstCertificateForSB() throws InterruptedException {
		...
		js.executeScript("document.getElementById('ctl00_HomePageContent_txtExmDate').value='01/06/2021'");//First Certificate claim for 7 days 

		JavascriptExecutor js1 = (JavascriptExecutor) driver;

		js1.executeScript("document.getElementById('ctl00_HomePageContent_txtNxtVisitDate').value='08/06/2021'");

		JavascriptExecutor js2 = (JavascriptExecutor) driver;

		js2.executeScript("document.getElementById('ctl00_HomePageContent_txtBODate').value='02/06/2021'");
...
//		driver.findElement(By.id("ctl00_HomePageContent_Button2")).click();
	...
	@Test(priority = 3)
	public void IntermediateCertificateForSB() throws InterruptedException{
	...
	//	benpg.Close().click();
		...
		js.executeScript("document.getElementById('ctl00_HomePageContent_txtFirstCertDate').value='01/06/2021'");

		JavascriptExecutor js1 = (JavascriptExecutor) driver;
		js1.executeScript("document.getElementById('ctl00_HomePageContent_txtExmDate').value='08/06/2021'");//Special Intermediate claim for 28 days

		JavascriptExecutor js2 = (JavascriptExecutor) driver;
		js2.executeScript("document.getElementById('ctl00_HomePageContent_txtNxtVisitDate').value='05/07/2021'");

		JavascriptExecutor js3 = (JavascriptExecutor) driver;
		js3.executeScript("document.getElementById('ctl00_HomePageContent_txtBODate').value='09/06/2021'");
	...
	@Test(priority = 4)
	public void SecondIntermediateCertificateForSB() throws InterruptedException{
		...
		JavascriptExecutor js1 = (JavascriptExecutor) driver;
		js1.executeScript("document.getElementById('ctl00_HomePageContent_txtExmDate').value='05/07/2021'");//Special Intermediate claim for 30 days

		JavascriptExecutor js2 = (JavascriptExecutor) driver;
		js2.executeScript("document.getElementById('ctl00_HomePageContent_txtNxtVisitDate').value='31/07/2021'");

		JavascriptExecutor js3 = (JavascriptExecutor) driver;
		js3.executeScript("document.getElementById('ctl00_HomePageContent_txtBODate').value='06/07/2021'");
...
//		driver.findElement(By.id("ctl00_HomePageContent_Button2")).click();
	...
	@Test(priority = 5)
	public void CreateClaimForSB() throws InterruptedException {
	...
	@Test(priority = 6)
	public void SicknessClaimForm() throws InterruptedException, AWTException {
		...
		js.executeScript("document.getElementById('ctl00_HomePageContent_txtFromDate').value='01/06/2021'");

		// To date
		JavascriptExecutor js1 = (JavascriptExecutor) driver;

		js1.executeScript("document.getElementById('ctl00_HomePageContent_txtToDate').value='05/08/2021'");
	...
	@Test(priority = 7)
	public void BMLoginforSB() throws InterruptedException, IOException {
	...
	@Test(priority = 8)
	public void SBProcessClaimBMLogin() throws InterruptedException {
	...
	public void tearDown(ITestResult result) throws IOException{
		...
		{
			String SBProcessClaim= utilobj.getScreenshot(driver, "SBClaim");
			logger.fail(result.getThrowable().getMessage(), MediaEntityBuilder.createScreenCaptureFromPath(SBProcessClaim).build());
